...
<body>
	<div class="main">
		...
		<div class="login_bottom">
			<img src="<%=request.getContextPath()%>/image/beijing2.jpg"
				width="1300px" height="500px"></img>
			<div class="login_bottom_xf">
			    <div class="text">管理员登录界面</div> 
				<form action="showAllTicket" method="post" id="login_form">
					登录名：<input type="text" name="adminName" class="login_text"><br>
